        ...
        children: [
            {
                ...
                resolve: { users: member_list_resolvers_1.MemberListResolver }
            },
            {
                path: 'members/:id',
                component: member_details_component_1.MemberDetailsComponent,
                resolve: { user: member_details_resolvers_1.MemberDetailsResolver }
            },
            {
                path: 'member/edit',
                component: member_edit_component_1.MemberEditComponent,
                resolve: { user: member_edit_resolvers_1.MemberEditResolver },
                canDeactivate: [prevent_unsave_changes_guard_1.PreventUnsaveChanges]
            },
            {
                path: 'messages',
                component: messages_component_1.MessagesComponent,
                resolve: { messages: message_resolvers_1.MessagesResolver }
            },
            {
                path: 'lists',
                component: list_component_1.ListComponent,
                resolve: { users: lists_resolvers_1.ListResolver }
            },
        ]
    },
